package uz.ilmnajot.college.utils;
import lombok.Data;
@Data
public class Utils {

    public static final String ADD_COLLEGE = "/add_college";

    public static final String GET_COLLEGE = "/get_college/{id}";

    public static final String GET_ALL_COLLEGE = "/all_college";

    public static final String UPDATE_COLLEGE = "/update_college/{id}";

    public static final String DELETE_COLLEGE = "/delete_college/{id}";


    public static final String CREATE_STUDENT = "/createStudent";

    public static final String GET_STUDENT = "/getStudent/{id}";

    public static final String GET_ALL_STUDENT = "/all";

    public static final String DELETE_STUDENT = "/deleteStudent/{id}";

    public static final String UPDATE_STUDENT = "/createStudent/{id}";
    ...
    public static final String BALANCE_ALREADY_EXIST = "BALANCE ALREADY EXIST";
    ...
    public static final String MAIN_BALANCE_NOT_FOUND = "MAIN_BALANCE_NOT_FOUND";
    public static final String MAIN_BALANCE_ALREADY_EXISTS = "MAIN_BALANCE_ALREADY_EXISTS";
    public static final String TRANSACTION_HISTORY_NOT_FOUND = "TRANSACTION_HISTORY_NOT_FOUND";
    ...
    public static final String DAILY_DRINKS_CONSUMED_NOT_FOUND = "DAILY_DRINKS_CONSUMED_NOT_FOUND";
